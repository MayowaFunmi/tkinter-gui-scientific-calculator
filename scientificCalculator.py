...
class Calc():
    ...
    #function to call entered numbers
    ...
    def loglp(self):
        self.result = False
        self.current = math.loglp(float(txtDisplay.get()))
        self.display(self.current)
...
btnMult = Button(calc, text = "X", width = 6, height = 2, font = ("arial", 20, "bold"), bd = 4, bg = "powder blue", command = lambda: added_value.operation("multi")).grid(row = 3, column = 3, pady = 1)
...
btnPM = Button(calc, text = "±", width = 6, height = 2, font = ("arial", 20, "bold"), bd = 4, bg = "powder blue", command = added_value.mathsPM).grid(row = 5, column = 2, pady = 1)
...
btnloglp = Button(calc, text = "loglp", width = 6, height = 2, font = ("arial", 20, "bold"), bd = 4, bg = "powder blue", command = added_value.loglp).grid(row = 5, column = 5, pady = 1)

btnexpml = Button(calc, text = "expml", width = 6, height = 2, font = ("arial", 20, "bold"), bd = 4, bg = "powder blue", command = added_value.expml).grid(row = 5, column = 6, pady = 1)
...
#-------------Menu and function---------------/-----/---/--//--
def iExit():
    iExit = tkinter.messagebox.askyesno("Scientific Calculator", "Confirm Exit?")
    if iExit > 0:
        root.destroy()
        return
